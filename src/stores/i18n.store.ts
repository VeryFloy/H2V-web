...
const dict: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'chats.delete_confirm': 'Удалить этот чат?',
    ...
    'msg.read_by': 'Прочитано',
    'msg.no_readers': 'Никто ещё не прочитал',
    'msg.retry': 'Нажмите для повторной отправки',
    'msg.send_failed': 'Не удалось отправить',
    ...
    'grp.add_description': 'Добавить описание',
    ...
    'grp.profile': 'Профиль',
    'grp.make_admin': 'Назначить админом',
    'grp.remove_admin': 'Снять админа',
    'grp.role_changed': 'Роль изменена',
    'grp.role_error': 'Не удалось изменить роль',
    ...
    'e2e.verify': 'Проверить',
    'e2e.safety_title': 'Код безопасности',
    'e2e.safety_hint': 'Сравните этот код с вашим собеседником, чтобы убедиться в шифровании.',
    ...
    'media_preview.send_image': 'Отправить изображение',
    'media_preview.send_video': 'Отправить видео',
    'media_preview.send_file': 'Отправить файл',
    'media_preview.as_document': 'Отправить как документ',
    'media_preview.caption': 'Подпись',
    'media_preview.caption_placeholder': 'Добавьте подпись...',
    'media_preview.add': 'Добавить',
    'date.today': 'Сегодня',
    ...
    'grp.create_invite': 'Создать ссылку-приглашение',
    'grp.copied': 'Скопировано!',
    'grp.copy': 'Копировать',
    'grp.searching': 'Поиск...',
  ...
  en: {
    ...
    'chats.delete_confirm': 'Delete this chat?',
    ...
    'msg.read_by': 'Read by',
    'msg.no_readers': 'No one has read yet',
    'msg.retry': 'Tap to retry',
    'msg.send_failed': 'Failed to send',
    ...
    'grp.add_description': 'Add description',
    ...
    'grp.message': 'Message',
    'grp.profile': 'Profile',
    'grp.make_admin': 'Make admin',
    'grp.remove_admin': 'Remove admin',
    'grp.role_changed': 'Role changed',
    'grp.role_error': 'Failed to change role',
    ...
    'e2e.verify': 'Verify',
    'e2e.safety_title': 'Safety Number',
    'e2e.safety_hint': 'Compare this number with your contact to verify encryption.',
    ...
    'common.send': 'Send',
    'media_preview.send_image': 'Send an image',
    'media_preview.send_video': 'Send a video',
    'media_preview.send_file': 'Send a file',
    'media_preview.as_document': 'Send as a document',
    'media_preview.caption': 'Caption',
    'media_preview.caption_placeholder': 'Add a caption...',
    'media_preview.add': 'Add',
    'date.today': 'Today',
    ...
    'grp.create_invite': 'Create invite link',
    'grp.copied': 'Copied!',
    'grp.copy': 'Copy',
